 ...
 */
@Service
public class PingServiceWithMappingPathImpl implements PingServiceWithMappingPath {

	/* (non-Javadoc)
	 * @see com.github.philippn.springremotingautoconfigure.test.service.PingServiceWithMappingPath#ping()
	 */
	@Override
	public String ping() {
		return "pong";
